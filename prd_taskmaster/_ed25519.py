"""Verify-only PureEdDSA Ed25519 implementation.

Vendored from scripts/license/ed25519_ref.py in this repository, which is a
small stdlib-only RFC 8032 reference implementation for Atlas license keys.
Runtime client code keeps only the public-key verification path.
"""
